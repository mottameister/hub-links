(function () {
  ...
  const translations = {
    ...
    "Torneio quinzenal de VGC no servidor. Inscrições da Poison Edition.": "Biweekly VGC tournament on the server. Poison Edition registrations.",
    ...
    "Consigo jogar domingo 7/jun: check-in às 19h e início às 19h30 (Horário BR).": "I can play on Sunday, Jun 7: check-in at 7 PM and start at 7:30 PM (Brazil time).",
