...
async function getInstagramMediaViews() {
  ...
  if (measured.length !== videos.length) {
    throw new Error("Instagram did not return views for every video");
  }
...
module.exports = { asNumber, getInstagramStats, getInstagramMediaViews };
